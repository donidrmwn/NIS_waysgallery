                ...
                <Modal.Footer className="d-flex justify-content-end">
                    {orderDetail?.status == "waiting" ?
                        ...
                        : orderDetail?.status == "success" ?
                            <Button onClick={() => props.openDetailProject(orderDetail)} variant="success" className="fw-bold d-flex justify-content-center align-items-center" style={{ width: "150px", height: "30px", fontSize: "13px" }}>View Project</Button>
                            :
                            <>
                                {props.getStatus(orderDetail?.status)}
                            </>
